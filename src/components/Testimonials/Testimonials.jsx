        ...
        <div className='container'>
            <div className='testimonials-content'>
                <div className='section-t text-center'>
                    <h3> Creative Minds Behind Kodegurus</h3>
                    <p className='text'>We Just not lucky to have a team like this but they are everything for the organization. At Kodegurus, our Creative Minds don’t miss a single opportunity to impress our clients.</p>
                </div>
